...
4. **[사용자 건강 정보] 블록의 실제 측정 수치를 본문에 숫자 그대로 인용** (반올림·생략 금지,
   최소 2개 이상). 예: "현재 몸무게 94.6kg, 혈압 127.5/75.5 mmHg, 공복혈당 88 mg/dL".
   이 인용은 필수이며, 누락 시 답변이 반려되어 재작성됩니다.
...
답변 구조 권장:
- 위험도 요약 (3개 질환 점수·등급 인용 + [사용자 건강 정보]의 실제 측정 수치 그대로 인용)
- 핵심 권고 (4측면 중 해당 항목)
