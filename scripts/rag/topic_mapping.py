...
_KSOLA2022: dict[str, list[str]] = {
    ...
    # ── Chapter 3. 생활습관요법 (KSLA2022 섹션 ID 기준) ──────────
    "KSLA2022_SEC_0025": ["diet", "lifestyle"],  # Ch.3 식사요법 — 고콜레스테롤 에너지·지방 권고안
    "KSLA2022_SEC_0026": ["diet", "lifestyle"],  # Ch.3 식사요법 — 트랜스지방·콜레스테롤·탄수화물
    "KSLA2022_SEC_0027": ["diet", "lifestyle"],  # 고중성지방혈증 에너지·지방
    "KSLA2022_SEC_0028": ["diet", "lifestyle", "alcohol"],  # 고중성지방혈증 탄수화물·당류·식이섬유·알코올
    "KSLA2022_SEC_0029": ["diet", "lifestyle"],  # LDL 식사요법 — 포화지방·콜레스테롤 권고안
    "KSLA2022_SEC_0030": ["diet", "lifestyle"],  # LDL 식사요법 — 식이섬유·식물성 스테롤 권고안
    "KSLA2022_SEC_0048": ["diet", "medication"],  # 복합 이상지질혈증 식사요법
    "KSLA2022_SEC_0068": ["diet", "lifestyle"],  # 이상지질혈증 식사요법 총론
